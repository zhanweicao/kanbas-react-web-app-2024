        ...
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    ...
                    <li>Divide dough in half, shape into disks, and refrigerate.</li>
                    <li>Mix apples, sugar, flour, cinnamon, nutmeg, and lemon juice.</li>
                    <li>Roll out one dough disk and place in pie dish.</li>
                    <li>Pour apple filling into crust.</li>
                    <li>Roll out second dough disk and place on top.</li>
                    <li>Trim, tuck, and crimp edges.</li>
                    <li>Cut slits in top crust, brush with egg, and sprinkle with sugar.</li>
                    <li>Bake at 425°F for 20 minutes.</li>
                    <li>Reduce heat to 375°F and bake for 40-50 minutes more.</li>
                    <li>Cool for 2 hours.</li>
                    <li>Serve and enjoy!</li>
                </ol>
